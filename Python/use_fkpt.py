...
def run_fkpt(proc = os.getpid(), pk_name='', Om = 0.317501, h = 0.6711, zout = 0.5,
             ...
             nquadSteps = 300, model='LCDM', fR0=1.0e-10, suffixModel= '', remove=True, chatty=0, rmin0=False):
    ...
    Args:
        ...
        rmin0: boolean, force rmin=0 for numerical testing (default: False)
    ...
    args_exe = [path_fkpt+'fkpt', 'Om=%f'%Om ,'h=%f'%h  , 'b1=%f'%b1, 'b2=%f'%b2, 'bs2=%f'%bs2,
                ...
                'model='+str(model)+'', 'fR0=%1.15f'%fR0, 'chatty=%f'%chatty, 'rmin0=%d'%(1 if rmin0 else 0)]
    #print(args_exe)
