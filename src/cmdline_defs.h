...
// Power spectrum table:
    ...
    "is_PS_input_LCDM=1",    ";=0 for MG pk input, =0 for LCDM pk input (the code rescale it to MG)",":isinLCDM", 
    "zout=0.5",                         ";Output redshift value",":z",
    //~ "Om=0.281",                     ";Omega matter value (z=0)",":OmegaM",
    "Om=0.3",                     ";Omega matter value (z=0)",":OmegaM",
    //~ "h=0.697",                         ";Hubble parameter",
    "h=0.67",                         ";Hubble parameter",
// bias parameters:
    "b1=1.0",                     ";Linear local bias",
    "b2=0.1",                     ";Second order local bias",
    "bs2=-0.1",                     ";tidal bias",
    "b3nl=0.1",                     ";b3nl bias",
    "alpha0=0.0",                     ";alpha0 EFT parameter",
    "alpha2=0.0",                     ";alpha2 EFT parameter",
    "alpha4=0.0",                     ";alpha4 EFT parameter",
    "ctilde=0.0",                     ";NLO EFT parameter. It is degenerate with alpha2shot, hence set one of them to zero",
    "pshotp=5000",                     "; Poissonian Shot Noise. Pshot = pshotp *(alpha0shot + alpha2shot mu^2 k^2). You can fix it to 1 and vary alpha0 shot noise",
    "alpha0shot=1",                     ";alpha0 shot noise Pshot = pshotp *(alpha0shot + alpha2shot mu^2 k^2)",
    "alpha2shot=0.0",                     ";alpha2 shot noise Pshot = pshotp *(alpha0shot + alpha2shot mu^2 k^2)",
//  k-functions
